...
import frc.robot.commands.ArcadeDriveBackwardsCommand;
...
public class OI {
  ...
  public Button Y = new JoystickButton(driverController, 4);
  public Button LB = new JoystickButton(driverController, 5);
  public Button RB = new JoystickButton(driverController, 6);
